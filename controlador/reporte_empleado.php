...
function Header()
{
 ...
 // Arial bold 15
    ...
    $this->Cell(121,15,'RECIBO DE PAGO',0,0,'C');
...
$consulta="select producto,precio,nombre_vendedor,fecha from ventas where nombre_vendedor='".$usuario."'";
...
while($row = mysqli_fetch_array($result))
{
    ...
    $column_price = $column_price.'$ '.$real_price*0.40."\n";
...
$pdf->SetX(15);
$pdf->MultiCell(178,8,'$ '.($total*0.40),1,'R');
...
$pdf->MultiCell(129,3," (".(mb_strtoupper($f->format($total*0.40)))." PESOS) MXN.",0,'R');
