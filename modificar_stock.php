                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <i class="fa fa-history icon-gradient bg-malibu-beach">
                                        </i>
                                    </div>
                                    <div>Modificar Stock
                                        <div class="page-title-subheading">Aqui podrás modificar el stock.
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body"><h5 class="card-title">Completa los Campos.</h5>
                                        <form class="">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="position-relative form-group">
                                                     <input name="producto" id="producto" placeholder="Producto" type="text"class="form-control">
                                                    </div>
                                                </div>
                                                 <div class="col-md-3">
                                                    <div class="position-relative form-group">
                                                    <input name="descripcion" id="descripcion" placeholder="Descripcion" type="email"
                                             class="form-control">
                                                    </div>
                                                </div> 
                                                <div class="col-md-3">
                                                    <div class="position-relative form-group">
                                                   <input name="cantidad" id="cantidad" placeholder="Cantidad" type="email"
                                                 class="form-control">
                                                    </div>
                                                </div> 
                                            </div>
                                             <input type="button" class="mt-2 btn btn-success" value="Guardar" onclick="modificar_stock()">
