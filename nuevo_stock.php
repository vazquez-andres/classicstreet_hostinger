                                ...
                                <div class="page-title-wrapper">
                                    <div class="page-title-heading">
                                        <div class="page-title-icon">
                                            <i class="fa fa-upload icon-gradient bg-malibu-beach">
                                            </i>
                                        </div>
                                        <div>Añadir Stock
                                            <div class="page-title-subheading">Aqui podrás agregar stock nuevo.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body"><h5 class="card-title">Completa los Campos.</h5>
                                        <form class="">
                                            <div class="form-row">
                                             ...
                                             <input type="button" class="mt-2 btn btn-success" value="Guardar" onclick="nuevo_stock()">
