...
// Print Results
tr('Red:','<font color="blue">'.inet_ntop($charNet)."/"._char2Cdr($charMask)."</font>");
tr('Rango:', '<font color="blue">'.inet_ntop($charHostMin).'  -->  '.inet_ntop($charHostMax).'</font>');
